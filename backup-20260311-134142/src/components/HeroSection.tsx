      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full">
        ...
        >
          ...
          >
            ...
            <h1 
              className="font-['Neo_Triad'] text-[120px] md:text-[140px] lg:text-[180px] font-bold tracking-normal filter [text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] leading-none flex" 
              style={{ fontFamily: "'Neo_Triad', sans-serif" }}
            >
              {/* Red 'T' with minimal vertical gradient */}
              <span 
                className="bg-clip-text text-transparent bg-gradient-to-b from-[#EA4335] to-[#d33c2f]"
              >
                T
              </span>
              ...
              <span 
                className="bg-clip-text text-transparent bg-gradient-to-b from-[#34A853] to-[#2e964a]"
              >
                X
              </span>
              ...
              <span 
                className="bg-clip-text text-transparent bg-gradient-to-b from-[#4285F4] to-[#3b77db]"
              >
                G
              </span>
            </h1>
          ...
          >
            {/* Subtitle */}
            <h2 className="font-['Neo_Triad'] text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight" style={{ fontFamily: "'Neo_Triad', sans-serif" }}>
              TECH <span className="text-[#00ff88] text-transparent bg-clip-text bg-gradient-to-r from-[#00ff88] via-[#00ff88]/60 to-[#00ff88]">X</span> Gaming
              <span className="block text-[#00ff88] text-transparent bg-clip-text bg-gradient-to-r from-[#00ff88] via-[#00ff88]/60 to-[#00ff88]">
                Expo Nagaland
              </span>
            </h2>
