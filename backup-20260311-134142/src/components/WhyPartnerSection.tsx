      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-['Neiko'] text-4xl md:text-6xl font-bold text-white mb-6">
            Strategic <span className="text-[#00ff88] font-['Neiko']">Partnership Benefits</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {partnershipBenefits.map((benefit, i) => (
            ...
            >
              <div className="p-8 rounded-2xl border border-[#2a2a2a]/50 bg-[#1a1a1a]/10 backdrop-blur hover:border-[#00ff88]/50 transition-all hover:shadow-[#00ff88]/25 hover:shadow-lg transition-all h-full">
                <div className="w-16 h-16 rounded-2xl bg-[#00ff88]/10 border border-[#00ff88]/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <GamingIcon 
        ...
        >
          <div className="p-8 rounded-2xl border border-[#2a2a2a]/50 bg-[#1a1a1a]/10 backdrop-blur">
            <h3 className="font-['Neiko'] text-4xl font-bold text-white text-center mb-8">
              Partnership <span className="text-[#00ff88] font-['Neiko']">Metrics</span>
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {brandMetrics.map((metric, i) => (
                <div key={i} className="text-center">
                  <div className="w-12 h-12 rounded-xl bg-[#2a2a2a]/50 flex items-center justify-center mx-auto mb-3">
                    <GamingIcon 
