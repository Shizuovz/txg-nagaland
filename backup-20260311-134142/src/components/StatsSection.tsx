    ...
    <div className="text-center p-2 relative">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="h-full w-full" style={{
          backgroundImage: `radial-gradient(circle, transparent 2px, #00ff88 2px)`,
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mt-2">
          <GamingIcon 
            ...
            color="#00ff88" 
          />
          <div className="text-[10px] md:text-xs font-medium uppercase tracking-wider leading-tight text-[#808080] font-['Nonito']">
            {stat.label}
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-['Neiko'] text-3xl md:text-6xl font-bold text-white">
            Big Numbers. <span className="text-[#00ff88]">Bigger Impact.</span>
          </h2>
        </motion.div>
        ...
        >
          <div className="p-5 md:p-8 rounded-2xl border border-[#2a2a2a]/50 bg-[#1a1a1a]/10 backdrop-blur-sm hover:border-[#00ff88]/50 transition-all hover:shadow-[#00ff88]/25 hover:shadow-lg relative overflow-hidden">
            {/* Dotted corner decoration */}
            <div className="absolute top-2 right-2 w-4 h-4">
              <div className="w-full h-full border-2 border-[#00ff88]/30 rounded-full" />
            </div>
            
            <h3 className="font-['Neiko'] text-xl md:text-2xl font-bold text-white mb-4 flex items-center gap-2">
              <GamingIcon iconId={GamingIcons.MONITOR} size={18} color="#00ff88" />
              On-Ground Audience
            </h3>
          ...
          <div className="p-5 md:p-8 rounded-2xl border border-[#2a2a2a]/50 bg-[#1a1a1a]/10 backdrop-blur-sm hover:border-[#00ff88]/50 transition-all hover:shadow-[#00ff88]/25 hover:shadow-lg relative overflow-hidden">
            {/* Dotted corner decoration */}
            <div className="absolute top-2 right-2 w-4 h-4">
              <div className="w-full h-full border-2 border-[#00ffff]/30 rounded-full" />
            </div>
            
            <h3 className="font-['Neiko'] text-xl md:text-2xl font-bold text-white mb-4 flex items-center gap-2">
              <GamingIcon iconId={GamingIcons.EYE} size={18} color="#00ff88" />
              Digital Audience
            </h3>
            <ul className="space-y-3 text-sm md:text-base text-white/70">
              <li className="flex items-start gap-3">
