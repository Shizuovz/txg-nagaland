        ...
        <div className="flex items-center justify-between h-16 md:h-20">
              ...
              <a
                ...
                className={`flex-1 text-center whitespace-nowrap text-sm font-medium transition-all duration-200 px-3 py-2 rounded-lg ${
                  scrolled 
                    ...
                    : "text-[#d0d0d0] hover:text-[#00ffff] hover:bg-[#00ff88]/10"
                }`}
              >
                {link.name}
              </a>
            ...
            {isAuthenticated ? (
              <div className="relative">
                <Button
                  variant="outline"
                  size="sm"
                  className={`w-10 h-10 rounded-full border-[#00ff88]/30 bg-[#00ff88]/10 text-[#00ff88] hover:bg-[#00ff88]/40 transition-all duration-200`}
                  onClick={() => setUserDropdownOpen(!userDropdownOpen)}
                >
                  <GamingIcon iconId={GamingIcons.USER} size={18} color="#00ff88" />
                </Button>
                <AnimatePresence>
                  {userDropdownOpen && (
                    <motion.div
                    ...
                    >
                      ...
                      <div className="p-1">
                        ...
                        <Button variant="ghost" size="sm" className="w-full justify-start text-[#e0e0e0] hover:text-[#808080] font-['Nonito']" onClick={() => navigate('/profile')}>
              ...
              <div className="flex items-center gap-2">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className={`transition-all duration-200 hover:bg-[#1a1a1a]/30 font-['Nonito'] ${
                    scrolled ? "text-[#b0b0b0]" : "text-[#d0d0d0]"
                  }`}
                ...
                <Button 
                  size="sm" 
                  className={`transition-all duration-200 font-['Nonito'] bg-[#00ff88] text-black hover:bg-[#00ff88]/90`}
          ...
          <button
            className={`lg:hidden p-2 rounded-xl transition-all duration-300 border flex items-center justify-center ${
              mobileOpen
                ? "bg-[#ff00ff]/10 border-[#ff00ff]/40 shadow-[0_0_15px_rgba(255,0,255,0.15)]" 
                : "bg-[#00ff88]/10 border-[#00ff88]/40 shadow-[0_0_15px_rgba(0,255,136,0.15)]"
            }`}
          ...
          >
            {mobileOpen ? (
              ...
              <GamingIcon iconId={GamingIcons.MENU} size={28} color="#00ff88" />
            )}
          </button>
        </div>
      </div>
